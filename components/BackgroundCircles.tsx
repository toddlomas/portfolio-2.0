...
function BackgroundCircles({}: Props) {
  return (
    ...
    >
      ...
      <div className="absolute border border-[white] rounded-full h-[500px] w-[500px] mt-52 opacity-10 animate-[ping_3s_ease-in-out_infinite] md:animate-none" />
      ...
      <div className="absolute border border-[#ea5c1f] rounded-full h-[1200px] w-[1200px] mt-52 opacity-70 animate-[ping_3s_ease-in-out_infinite]" />

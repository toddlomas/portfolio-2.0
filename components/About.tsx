  ...
  return (
    <Suspense fallback={<h2>Loading...</h2>}>
      ...
      <motion.div
        ...
        className="h-screen flex flex-col relative text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center top-0"
      >
        <h3 className="absolute top-0 sm:top-24 uppercase tracking-[20px] text-gray-500 text-2xl invisible sm:visible">
          About
        </h3>
        <motion.img
        ...
        <div className="space-y-10 px-0 md:px-10">
          ...
          <div>
            <p className="text-[0.75rem] sm:text-base text-gray-400 overflow-y-scroll scrollbar-thin scrollbar-track-black pb-[4rem] sm:pb-0">
